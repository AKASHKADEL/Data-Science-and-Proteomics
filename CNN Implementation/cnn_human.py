...
filtered = [(a,b) for (a,b) in zip(train_seqsHuman, y_trainHuman) if len(a) <= 5000]
...
def train(ValidSeqsHuman, yValidHuman, num_epochs, optimizer, data_iter, model, training_length):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        evaluate_and_save(model, opt.out_dir, val_outputs, valid_label, losses, eval_loss.data[0], "human", epoch)
