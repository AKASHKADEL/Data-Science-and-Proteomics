...
test_set_file = opt.main_data_dir + 'human_MF_temporal_holdout.mat'
...
train(ValidSeqsHuman_small, yValidHuman_small, opt.n_epochs, optimizer, data_iter, model, data_size)
